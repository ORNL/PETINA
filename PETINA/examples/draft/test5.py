...
batch_size = 256 # Smaller batch size for better generalization and faster updates
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, kernel_size=3, stride=2, padding=1)  # Changed from 1 to 3
